...
def test_getters_and_setters():
    ...
    money_manager = MoneyManager(dir_path + "\\json\\MoneyData.json")
...
def test_record_money():
    ...
    money_manager.record_money(updated_money_json, dir_path + "\\json\\MoneyDataAfterBuyDrink.json")

    # create another MoneyManager from stored file and assert the values
    money_manager_after = MoneyManager(dir_path + "\\json\\MoneyDataAfterBuyDrink.json")
